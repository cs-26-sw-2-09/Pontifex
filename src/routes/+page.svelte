...
<div class="flex min-h-screen flex-col items-center justify-center bg-gray-100 text-center">
	...
	<div class="mt-10 flex gap-6">
		...
		<div class="flex flex-col gap-2">
			<select bind:value={selectedStudent} class="rounded-xl border border-blue-400 px-6 py-3 text-blue-400 bg-white shadow-md">
		...
		<!-- Teacher -->
		<div class="flex flex-col gap-2">
			<select bind:value={selectedTeacher} class="rounded-xl border border-emerald-400 px-6 py-3 text-emerald-400 bg-white shadow-md">
		...
		<!-- Admin -->
		<div class="flex flex-col gap-2">
			<select bind:value={selectedAdmin} class="rounded-xl border border-red-400 px-6 py-3 text-red-400 bg-white shadow-md">
